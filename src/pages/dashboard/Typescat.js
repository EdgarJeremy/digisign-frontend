...
export default class Typescat extends React.Component {
    ...
    async fetch() {
        ...
        const categories = await models.Category.collection({
            attributes: ['name'],
    ...
    render() {
        const { keyword, categories, loading, activePage, displayLength, showAddModal, showEditModal, showDeleteModal, toDelete, selected, deleteLoading } = this.state;
        return (
            <div className="contain" style={{ padding: 14 }}>
                ...
                <div className="panel">
                    <div className="panel-toolbar">
                        <div className="panel-toolbar-left">
                            <IconButton onClick={() => this.setState({ showAddModal: true })} icon={<Icon icon="plus" />} placement="left">Tambah Kategori</IconButton>
                        </div>
                    ...
                    <Table.Pagination
                        ...
                        total={!loading ? categories.count : 0}
                ...
                <Modal show={showAddModal} onHide={() => this.setState({ showAddModal: false })} size="xs">
                    ...
                    <Modal.Body>
                        <AddTypescat {...this.props} onSuccess={this.fetch.bind(this)} />
                    </Modal.Body>
                </Modal>
