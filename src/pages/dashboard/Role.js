...
export default class Role extends React.Component {
    ...
    async fetch() {
        ...
        const roles = await models.Role.collection({
            attributes: ['name'],
        ...
        return (
            <div className="contain" style={{ padding: 14 }}>
                ...
                <div className="panel">
                    <div className="panel-toolbar">
                        <div className="panel-toolbar-left">
                            <IconButton onClick={() => this.setState({ showAddModal: true })} icon={<Icon icon="plus" />} placement="left">Tambah Peran</IconButton>
                        </div>
                ...
                <Modal show={showAddModal} onHide={() => this.setState({ showAddModal: false })} size="xs">
                    <Modal.Header>
                        <Modal.Title>Peran Baru</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <AddRole {...this.props} onSuccess={this.fetch.bind(this)} />
                    </Modal.Body>
                </Modal>
                ...
                <Modal show={showEditModal} onHide={() => this.setState({ showEditModal: false, selected })} size="xs">
                    ...
                    <Modal.Body>
                        {selected && <EditRole {...this.props} role={selected} onSuccess={this.fetch.bind(this)} />}
                    </Modal.Body>
                </Modal>
